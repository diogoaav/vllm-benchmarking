...
def process_json_file(file_path):
    ...
    return {
        ...
        "median_e2el_ms": data.get("median_e2el_ms", "N/A"),
        "p99_e2el_ms": data.get("p99_e2el_ms", "N/A"),
...
def main(yaml_path, gpu_type):
    ...
    for config in configs:
        ...
        log_file = f"rocm_profile_{timestamp}_c{config['prompt_length']}_l{config['output_length']}.csv"
    ...
    move_results()
    zip_folder("results", "benchmark_results_test2.zip")
